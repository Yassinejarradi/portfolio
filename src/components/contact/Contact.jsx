          ...
          <div className="contact_content">
            ...
            <div className="contact_info">
              ...
              <div className="contact_card">
                ...
                <span className="contact_card-data">+212 661523750</span>
                <a
                  href="https://api.whatsapp.com/send?phone=+212688505361&text=Hello, more information!
"
                  className="contact_button">
                  Write me{" "}
                  <i className="bx bx-right-arrow-alt contact_button-icon"></i>
              ...
              <div className="contact_card">
                ...
                <h3 className="contat_card-title">Linkedin</h3>
                <span className="contact_card-data">Jarradi Yassine</span>
                <a href="https://www.linkedin.com/in/yassine-jarradi-121292228/" className="contact_button">
                  Write me{" "}
                  <i className="bx bx-right-arrow-alt contact_button-icon"></i>
                </a>
              </div>
